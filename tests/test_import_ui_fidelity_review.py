...
@pytest.mark.xfail(
    strict=True,
    reason="ezdxf parsing of 50 000 LINE entities alone takes ~4.5 s on the review machine "
    "(i5-5350U), plus the Python IGP gates; needs a streaming DXF entity reader",
)
